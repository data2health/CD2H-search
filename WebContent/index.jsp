...
<body class="home page-template-default page page-id-6 CD2H">
			...
			<c:choose>
				<c:when test="${not empty param.query}">
					...
					<div style="width: 100%; float: left">
						<lucene:taxonomy
							taxonomyPath="/usr/local/CD2H/lucene/cd2hsearch_tax">
							...
							<c:set var="drillDownList">
								<lucene:drillDownProcessor categoryPaths="${param.drillDown}"
									drillUpCategory="${param.drillUp}"
									drillOutCategory="${param.drillOut}" />
							</c:set>

							<lucene:search lucenePath="/usr/local/CD2H/lucene/cd2hsearch"
								label="content" queryParserName="boolean"
								queryString="${param.query}" useConjunctionByDefault="true">
								<div style="with: 100%">
									<div id="facet-box"
										style="width: 40%; padding: 0px 80px 0px 0px; float: left">
										<h5>Facets:</h5>
															...
															<div class='facet-top-content-box'>
																...
																<li>
																	...
																	<div class='facet-list-item'>
																		<lucene:facet label="content"> (<lucene:facet
																				label="count" />)
												
																	</div> <!-- Toggles Collapse based on which facets are hot  -->
			...
			<div id="results-table" onscroll="scrollFunction()">
				<table style="width: 100%">
					...
					<lucene:searchIterator>
						<tr>
							<td><a href="<lucene:hit label="uri" />"><lucene:hit
										label="label" /></a></td>
	...
	<c:otherwise>
		<div class='desc-text' style="width: 80%;">
			<p>
				This proof-of-concept explores multi-faceted search across multiple
				federated sources, both internal to CD2H and the CTSA Consortium and
				more broadly across the entire informatics community. <b>Comments
					and questions are welcome!</b> We are particularly interested in
				feedback regarding the nature and organization of the facets used to
				filter search results. The facet taxonomy is readily restructured as
				we index data.
			</p>
		</div>
		...
		<div class="container-fluid">
			...
			<h4 style="text-align: center; font-weight: 400;">
				<i style="color: #6ba097;" class="fas fa-database"></i> Sources and
				Entity Types:
			</h4>
			<br>
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">
								<a href="http://research.icts.uiowa.edu/polyglot/">CTSAsearch</a>
								<p>(238,894 entries)</p>
							</h5>
							<ul class="list-group">
				...
				<div class="col-sm-3">
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">
								<a href="https://datamed.org/">DataMed.org (bioCADDIE)</a>
								<p>(1,252,785 entries)</p>
							</h5>
							<ul class="list-group">
								<li>Data Sets</li>
							</ul>
				...
				<div class="col-sm-3">
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">
								<a href="https://datacite.org/">DataCite.org</a>
								<p>(14,805,692 entries)</p>
							</h5>
							<ul class="list-group">
								<li>Data Sets</li>
								<br>
			...
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">
								<a href="http://alaska.dev.eagle-i.net/">N-Lighten</a>
								<p>(110 entries)</p>
							</h5>
							<ul class="list-group">
								<li>Users</li>
				...
				<div class="col-sm-3">
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">
								<a href="https://clic-ctsa.org/diamond">DIAMOND</a>
								<p>(103 entries)</p>
							</h5>
							<ul class="list-group">
				...
				<div class="col-sm-3">
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">
								<a href="https://clic-ctsa.org/education">CLIC Education
									Clearinghouse</a>
								<p>(30 entries)</p>
							</h5>
							<ul class="list-group">
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">
								<a
									href="https://grants.nih.gov/funding/searchguide/index.html#/">NIH
				...
				<div class="col-sm-3">
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">
								<a href="https://www.project-redcap.org">REDCap Library</a>
								<p>(2,142 entries)</p>
							</h5>
							<ul class="list-group">
				...
				<div class="col-sm-3">
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">
								<a href="https://sparc.musc.edu">MUSC SPARCRequest</a>
								<p>(21,809 entries)</p>
							</h5>
							<ul class="list-group">
								<li>Services</li>
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">
								<a href="https://www.ncbi.nlm.nih.gov/pubmed">NIH PubMed -
									partial (MEDLINE)</a>
								<p>(3,364,632 entries)</p>
							</h5>
							<ul class="list-group">
								<li>Articles</li>
							</ul>
				...
				<div class="col-sm-3">
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">
								<a href="https://projectreporter.nih.gov/reporter.cfm">NIH
									RePORTER</a>
								<p>(429,612 entries)</p>
							</h5>
							<ul class="list-group">
